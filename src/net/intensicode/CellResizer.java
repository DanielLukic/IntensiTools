...
public final class CellResizer
    ...
    public static final void main( final String[] aArgs ) throws IOException
        {
        final int cellsPerRow = 6;
        final int cellsPerColumn = 1;

        final int toCellWidth = 8;
        final int toCellHeight = 8;

        final boolean centered = true;

        final String inputFileName = "res/Galaxina/Default/debris3.png";
    ...
    public static final String makeOutputFileName( final String aInputFileName )
        {
